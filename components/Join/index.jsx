    ...
    return (
        <Box bg="gray.100">
            <Container maxW="container.xl" pt="4">
                <Heading as='h1' fontSize={{ base: "2xl", md: "3xl", lg: "5xl" }} color="blue.700" fontWeight="bolder" textAlign="center">Join Us</Heading>
                <SimpleGrid columns={{ base: 1, lg: 2 }}>
                    <Box bg="white" px="3" boxShadow="xl" rounded="md" maxW="700px" mx="auto" mt="4" d="flex" alignItems="center">
                        <Box maxW="420px">
                    ...
                    <Box align="center" bg="white" p={8} boxShadow="xl" rounded="md" maxW="500px" mx="auto" mt="4">
                        ...
                        <Text fontWeight="bold" fontSize="3xl" color="orange.400">Mondays @ 5-6 PM</Text>
                        <Text fontWeight="bold" fontSize="3xl" color="blue.700">Room: Beall 7</Text>
